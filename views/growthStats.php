        ...
        if(!empty($_FILES["image"]["name"])){
            ...
            if(in_array($fileType, $allowTypes)){ 
              if(move_uploaded_file($_FILES["image"]["tmp_name"], $targetFilePath)){
                $query = "INSERT INTO crayfishdata (imagedata,averagesize, growthrate) 
                          VALUES ('$fileName', '$values', '$values')"; 
              }
      ...
      <form id="dataForm" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="initial">
          <div class="input-card">
            ...
            <input class="inputs" type="text" name="weight" required>
          </div>
          <div class="input-card">
            <label for="sizes[]">Size(inch):</label>
            <input class="inputs" type="text" name="sizes[]" required>
          </div>
        </div>
